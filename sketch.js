...
let menu = {
    ...
    items: [
        ...
        { text: "測驗卷.", link: "https://zhang20432-beep.github.io/20251028/" },
        { text: "測驗卷筆記.", link: "https://hackmd.io/@P6gPl0KeQ7mpAQk7Nr4c6Q/Hkw7_yD1-l" },
        { text: "作品筆記.", link: "https://hackmd.io/@P6gPl0KeQ7mpAQk7Nr4c6Q/SkU1MKb3ee" },
        {
            text: "淡江大學",
            link: "https://www.tku.edu.tw",
            subItems: [
                { text: "教育科技學系", link: "https://hackmd.io/@cfchen/SJomYtHyWx" }
            ]
        },
        { text: "關閉視窗.", link: null }
    ],
...
function mousePressed() {
    if (menu.x > -menu.w && // 只有當選單可見時才處理
        ...
        if (idx >= 0 && idx < menu.items.length && !menu.items[idx].subItems) {
            console.log("選擇:", menu.items[idx].text);
            menu.selected = idx;
            if (menu.items[idx].link) {
                openIframe(menu.items[idx].link);
            } else {
                closeIframe();
            }
        }
